...
// Lấy 1 review chi tiết theo ID (cho trang ReviewAllDetail)
router.get('/detail/:id', ReviewController.getOneById);

// Lấy danh sách chi tiết review theo SKU
router.get('/:skuId', ReviewController.getBySku);

// Phản hồi đánh giá
router.patch('/reply/:id', ReviewController.replyToReview);
