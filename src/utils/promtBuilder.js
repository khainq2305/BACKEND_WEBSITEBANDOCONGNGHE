module.exports = [
  ...
  {
    match: /(hủy đơn|đổi địa chỉ|đặt nhầm|chuyển giúp đơn|sai địa chỉ|thay địa chỉ)/i,
    response: `⚠️ Anh/chị vui lòng nhắn mã đơn hoặc số điện thoại đặt hàng, em sẽ hỗ trợ hủy hoặc điều chỉnh đơn ngay nhé!`
  },
  {
    match: /(shop ở đâu|địa chỉ|chi nhánh|cửa hàng)/i,
  ...
  {
    match: /(làm việc|giờ mở cửa|thời gian làm việc)/i,
  ...
  },
  {
    ...
    response: `📞 Anh/chị có thể gọi hotline <strong>1900 8922</strong> hoặc nhắn tin qua fanpage để được hỗ trợ nhanh nhất ạ!`
  },
  {
  ...
  },
  {
    ...
    response: `🔄 Bên em hỗ trợ đổi trả trong 7 ngày nếu sản phẩm có lỗi từ nhà sản xuất. Anh/chị nhớ giữ hóa đơn và bao bì đầy đủ nhé!`
  },
  {
    match: /(vận chuyển|giao hàng|ship hàng|mua online|nhận hàng)/i,
    response: `🚚 Bên em hỗ trợ giao hàng toàn quốc, nhanh chóng và an toàn. Anh/chị chỉ cần đặt hàng trên website hoặc nhắn với em để được hỗ trợ nhé!`
  },
  {
    match: /(thanh toán|trả tiền|cách thanh toán|quẹt thẻ)/i,
    response: `💳 Bên em hỗ trợ thanh toán bằng tiền mặt khi nhận hàng (COD), chuyển khoản và quẹt thẻ tại cửa hàng nếu có nhu cầu.`
  }
];
